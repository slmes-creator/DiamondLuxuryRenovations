      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="bg-white rounded-3xl shadow-2xl p-12 text-center">
          <img
            ...
            className="w-32 h-32 rounded-full object-cover object-[70%_50%] scale-[2] shadow-xl mx-auto mb-6"
            data-testid="img-owner"
          />
          <h4
            className="text-2xl font-bold text-diamond-900 mb-2"
            data-testid="text-owner-name"
          >
            Ronald
          </h4>
          <p className="text-luxury-600 font-semibold mb-4">
            Owner & Master Craftsman
          </p>
          <p className="text-gray-700 text-lg max-w-2xl mx-auto italic">
            "I started Diamond Luxury Renovation because I was tired of seeing
            homeowners disappointed by poor craftsmanship. Every project we
            complete is a reflection of our commitment to excellence."
          </p>
        </div>
      </div>
    </section>
